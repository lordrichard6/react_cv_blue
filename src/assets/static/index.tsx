...
export const projectsInfo = [
    {
        img: 'https://i.ibb.co/Npwb84D/p09-min.jpg',
        id: 1,
    ...
    {
        img: 'https://i.ibb.co/1KKkWfn/p08-min.jpg',
        id: 2,
        title: "Hulu clone",
        tech: 'Next.js',
    ...
    {
        img: 'https://i.ibb.co/mcd7k0T/p07-min.jpg',
        id: 3,
        title: "Paul's Engine",
        tech: 'React.js',
    ...
    {
        img: 'https://i.ibb.co/BqZRGyT/p06-min.jpg',
        id: 4,
        title: "Skytours",
        tech: 'React.js',
    ...
    {
        img: 'https://i.ibb.co/MRvg9y1/p05-min.jpg',
        id: 5,
        title: "Monkey Circus",
        tech: 'Next.js',
    ...
    {
        img: 'https://i.ibb.co/XDVPrMC/p03-min.jpg',
        id: 6,
    ...
    // },
    {
        img: 'https://i.ibb.co/nm7sK0C/p02-min.jpg',
        id: 9,
        title: "Netflix Copy",
        tech: 'Javascript',
    ...
    {
        img: 'https://i.ibb.co/mGWxBnZ/p01-min.jpg',
        id: 10,
        title: "FlappyBird",
        tech: 'Javascript',
    ...
    {
        img: 'https://i.ibb.co/xCnSn30/p11-min.jpg',
        id: 11,
        title: "ThreeJS",
        tech: 'Three.js',
